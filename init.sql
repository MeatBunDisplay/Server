...
INSERT PlaceData VALUES (10, NULL);

INSERT MeatButType VALUES(UUID_TO_BIN(UUID()), "ダミーマン", 100, CAST("0500" AS TIME), "ダミーの肉まんです", NULL, CAST(NOW() AS DATETIME), CAST(NOW() AS DATETIME));